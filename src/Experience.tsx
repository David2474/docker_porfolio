          ...
          <div className="space-y-12 relative">
              ...
              <div className="flex-1 pl-8">
                <Card className="bg-slate-800/70 backdrop-blur-md border-slate-600 text-white shadow-xl">
                  <CardHeader>
                    ...
                    <CardDescription className="text-gray-200 font-medium">Nissosi</CardDescription>
                  </CardHeader>
                  <CardContent>
            ...
            <div className="relative flex items-center">
              <div className="flex-1 pr-8 text-right">
                <Card className="bg-slate-800/70 backdrop-blur-md border-slate-600 text-white shadow-xl">
                  <CardHeader>
                    <CardTitle className="text-purple-400 text-lg">Desarrollador Web</CardTitle>
                    <CardDescription className="text-gray-200 font-medium">Freelancer</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="flex justify-end mb-2">
